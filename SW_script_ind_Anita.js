...
function anitaData(a, b, c) {
  ...
  var TITLE = 'Anita\'s 2019 Cases'; //text title

  var LABELS = 'Anita_Date';  // Column from dataset that will populate x-axis tick labels (team members)

  var SERIES = [  // For each column representing a series, define its name and color
    {
      column: 'Anita_caseload',
      name: 'Active Cases',
      color: '#0B877D'
    }//,
//    {
...
//    }
  ...
  d3.csv('https://raw.githubusercontent.com/Chyanne-E/SocialWorkApp/master/lineAnita.csv').then(function(rows) {
    ...
    var ctx = document.getElementById('cont_Anita').getContext('2d');
