function anthonyData(a, b, c) {
  ...
  var TITLE = 'Anthony\'s 2019 Cases'; //text title

  var LABELS = 'Anthony_Date';  // Column from dataset that will populate x-axis tick labels (team members)

  var SERIES = [  // For each column representing a series, define its name and color
    {
      column: 'Anthony_caseload',
      name: 'Anthony Cases',
      color: 'green'
    }//,
//    {
...
//    }
  ...
  d3.csv('https://raw.githubusercontent.com/Chyanne-E/SocialWorkApp/master/lineAnthony.csv').then(function(rows) {
    ...
    var ctx = document.getElementById('cont_Anthony').getContext('2d');
