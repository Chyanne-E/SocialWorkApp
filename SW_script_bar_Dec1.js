$(document).ready(function() {
  ...
  var TITLE = 'Team Cases on December 1'; //text title
...
//    }
  ...
  d3.csv('https://raw.githubusercontent.com/Chyanne-E/SocialWorkApp/master/bar_Dec1.csv').then(function(rows) {
    ...
    var ctx = document.getElementById('bar_Dec1')//.getContext('2d');
