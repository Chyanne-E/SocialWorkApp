$(document).ready(function() {
  ...
  var LABELS = 'Date';  // Column from dataset that will populate x-axis tick labels (team members)
...
//    }
  ...
  d3.csv('https://raw.githubusercontent.com/Chyanne-E/SocialWorkApp/master/JS_countsProof.csv').then(function(rows) {
